...
from ..memory import LocalMemoryProvider
...
try:
    prom_tasks_submitted = prom.Counter(
        "codin_tasks_submitted_total", 
...
try:
    prom_task_queue_length = prom.Gauge(
        "codin_task_queue_length", 
