...
This module provides a host for running one or more codin agents that can collaborate.
"""
...
from ..agent.dag_planner import DAGPlanner, DAGExecutor
from ..model.base import BaseLLM
from ..protocol.types import Message, TextPart, DataPart, AgentRunInput, AgentRunOutput
...
prom_agent_runs = prom.Counter(
    "codin_agent_runs_total", 
...
prom_agent_errors = prom.Counter(
    "codin_agent_errors_total", 
    "Number of agent errors",
    ["agent_id", "error_type"]
)

prom_messages_sent = prom.Counter(
    "codin_messages_sent_total", 
    "Number of messages sent",
    ["agent_id"]
)

prom_messages_received = prom.Counter(
    "codin_messages_received_total", 
