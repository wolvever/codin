...
"""LLM factory for automatic provider selection based on environment variables.

This module provides a factory class that can automatically select and create
the appropriate LLM implementation based on the LLM_PROVIDER environment variable.
This is especially useful for proxy services that provide OpenAI-compatible APIs
for other models like Claude.
"""
...
class LLMFactory:
    ...
    def create_llm(cls, 
                   ...
                   base_url: str | None = None) -> BaseLLM:
