...
from ..model import ModelRegistry, BaseLLM
from .registry import get_registry
from .base import (
    RenderedPrompt, ToolDefinition, PromptResponse
)
...
class PromptEngine:
    ...
    def _create_message(self, content: str, role: Role = Role.agent,
    ...
    async def _prepare_variables(self, variables: dict[str, _t.Any], tools: list[ToolDefinition] | None, 
    ...
    async def run(self, name: str, /, *, version: str | None = None, 
                 variables: dict[str, _t.Any] | None = None, tools: list[ToolDefinition] | None = None,
                 conditions: dict[str, _t.Any] | None = None,
                 stream: bool = False, context_id: str | None = None, task_id: str | None = None,
        ...
        try:
            ...
            logger.debug("Calling LLM %s with template %s@%s", 
                        capabilities["model"], template.name, template.version)
            ...
            if rendered_prompt.system_prompt or rendered_prompt.messages:
                ...
                if tools and capabilities["tool_support"] and hasattr(self.llm, 'generate_with_tools'):
                    ...
                    if hasattr(self.llm, 'generate_messages'):
            ...
            if stream and hasattr(completion, '__aiter__'):
                ...
                response.message = self._create_message(
                    content=content_str, role=Role.agent,
    ...
    async def render_only(self, name: str, /, *, version: str | None = None,
                         variables: dict[str, _t.Any] | None = None, 
                         conditions: dict[str, _t.Any] | None = None,
                         **kwargs) -> RenderedPrompt:
