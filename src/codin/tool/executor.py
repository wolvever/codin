"""Tool execution engine for codin agents.

This module provides the core tool execution infrastructure including
approval modes, safety checks, and execution context management.
"""
