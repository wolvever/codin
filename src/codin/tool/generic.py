"""Generic tool implementation that delegates to a ToolExecutor."""
...
class GenericTool(Tool):
    ...
    async def run(self, args: _t.Dict[str, _t.Any], tool_context: ToolContext) -> _t.Any:
        ...
        try:
            ...
            self.logger.error(f"Error executing target tool '{self.target_tool_name}': {str(e)}")
            ...
            async def run(self, args: _t.Dict[str, _t.Any], tool_context: ToolContext) -> _t.Any:
                ...
                if inspect.iscoroutinefunction(func):
                    ...
                    return await loop.run_in_executor(
                        None,
                        lambda: func(**args, tool_context=tool_context)
                    )
