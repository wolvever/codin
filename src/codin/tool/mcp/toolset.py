...
"""Toolset implementation for collections of MCP tools.

This module provides the MCPToolset class, which manages collections of MCP
...
from ..base import Tool, Toolset, LifecycleState
...
class MCPToolset(Toolset):
    ...
    def __init__(
        ...
        **kwargs:
        ...
        self._session_manager = MCPSessionManager.create(
                ...
                if self._session_manager:
                    try:
                        ...
                        await asyncio.shield(
                            asyncio.wait_for(self._session_manager.close(), timeout=1.0)
                        )
                    except Exception:
