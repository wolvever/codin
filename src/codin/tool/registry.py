...
class ToolEndpoint(_pyd.BaseModel):
    ...
    auth: _t.Optional[dict[str, _t.Any]] = _pyd.Field(None, description="Authentication configuration")
...
class ToolRegistryConfig(_pyd.BaseModel):
    ...
    sandbox: _t.Optional[dict[str, _t.Any]] = _pyd.Field(None, description="Sandbox configuration")
...
class ToolRegistry:
    ...
    def __init__(self, config: _t.Optional[ToolRegistryConfig] = None):
    ...
    def register_toolset(self, toolset: Toolset, remove_prefix: bool = None) -> None:
        ...
        should_remove_prefix = (
            remove_prefix if remove_prefix is not None 
            else self.config.tool_prefix_removal
        )
    ...
    def get_toolset(self, name: str) -> _t.Optional[Toolset]:
        """Get a toolset by name."""
        return self._toolsets.get(name)
    
    def get_tool(self, name: str) -> _t.Optional[Tool]:
        """Get a tool by name."""
    ...
    def get_toolsets(self) -> _t.List[Toolset]:
        """Get all registered toolsets."""
        return list(self._toolsets.values())
    
    def get_tools_with_executor(self) -> _t.List[Tool]:
