...
from src.codin.client import Client, ClientConfig  # For spec and config
...
class TestVLLMClient:
    ...
    async def test_init_from_config(self, mock_vllm_internal_client):
        ...
        with patch(
            "src.codin.model.openai_compatible_llm.Client", return_value=mock_vllm_internal_client
